...
chooseRunIDgroup = 1 # 0: sOU data, 1: uOU data, 2: mDDM data, 3: pDDM data, 4: LCA data 
...
if dataSetID == 1:
	xStart3 = [0.274,0.306,0.078,0.076,0.097,3.576]
elif dataSetID == 2:
	xStart3 = [0.221,0.309,0.084,0.068,0.141,1.078]
elif dataSetID == 6:
	xStart3 = [0.368,0.556,0.063,0.061,0.167,1.378]
elif dataSetID == 9:
	xStart3 = [0.177,0.530,0.083,0.058,0.180,3.231]
elif dataSetID == 13:
	xStart3 = [0.199,0.663,0.057,0.063,0.157,2.283]
elif dataSetID == 19:
	xStart3 = [0.183,0.565,0.072,0.075,0.100,2.558]
if dataSetID in [1,2,6,9,13,19]:
	fVal3 = Fobj_AIC_BIC(xStart3, param_names, pFixedDict, fittedModel, NtrialsGetInitBest3, TMAXdec, stimulus_value_pairs, cond_list,
			bin_edges_allConds_Opt1, abs_freq_allConds_Opt1, bin_edges_allConds_Opt2, abs_freq_allConds_Opt2)
	fValList.append(fVal3)
	xStartList.append(xStart3)
...
for rep in range(REPETITIONS):
	FitRes = minimize(Fobj_AIC_BIC, xStart, args=(param_names, pFixedDict, fittedModel, NtrialsSimplex, TMAXdec,
		...
		bin_edges_allConds_Opt1, abs_freq_allConds_Opt1,
		bin_edges_allConds_Opt2, abs_freq_allConds_Opt2),
		method='Nelder-Mead', options={'maxiter': 10000, 'maxfev': 20000, 'ftol': FitTolerance, 'xtol': 1e-3}) # 'ftol': 100, 'xtol': 1e-3
