...
chooseRunIDgroup = 3 # 0: sOU data, 1: uOU data, 2: mDDM data, 3: pDDM data, 4: LCA data 
...
if dataSetID == 1:
	xStart3 = [0.109,0.595,0.048,0.055]
elif dataSetID == 2:
	xStart3 = [0.104,0.420,0.035,0.052]
elif dataSetID == 6:
	xStart3 = [0.103,0.513,0.028,0.062]
elif dataSetID == 9:
	xStart3 = [0.148,0.321,0.044,0.074]
elif dataSetID == 13:
	xStart3 = [0.078,0.601,0.035,0.079]
elif dataSetID == 19:
	xStart3 = [0.106,0.311,0.044,0.065]
