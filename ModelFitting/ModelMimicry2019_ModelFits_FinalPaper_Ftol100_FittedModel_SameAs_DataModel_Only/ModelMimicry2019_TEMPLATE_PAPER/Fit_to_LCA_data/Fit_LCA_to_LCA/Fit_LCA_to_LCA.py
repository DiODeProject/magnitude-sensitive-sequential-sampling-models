...
chooseDataSetType = 'LCA' # 'DDMOU' or 'LCA'
if len(sys.argv) > 1:
...
chooseRunIDgroup = 4 # 0: sOU data, 1: uOU data, 2: mDDM data, 3: pDDM data, 4: LCA data 
...
if dataSetID == 1:
	xStart3 = [0.421,0.385,0.137,1.010,0.226]
elif dataSetID == 2:
	xStart3 = [0.290,0.490,0.066,0.700,0.240]
elif dataSetID == 6:
	xStart3 = [0.360,0.643,0.124,0.212,1.535]
elif dataSetID == 9:
	xStart3 = [0.216,0.570,0.120,1.113,1.234]
elif dataSetID == 13:
	xStart3 = [0.426,0.388,0.162,0.574,1.834]
elif dataSetID == 19:
	xStart3 = [0.208,0.393,0.069,0.742,1.394]
