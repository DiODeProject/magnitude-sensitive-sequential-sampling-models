...
chooseRunIDgroup = 0 # 0: sOU data, 1: uOU data, 2: mDDM data, 3: pDDM data, 4: LCA data 
...
if dataSetID == 1:
	xStart3 = [0.274,0.385,0.083,0.065,0.172,-3.479]
elif dataSetID == 2:
	xStart3 = [0.132,0.490,0.058,0.043,0.073,-3.964]
elif dataSetID == 6:
	xStart3 = [0.247,0.634,0.067,0.060,0.197,-1.699]
elif dataSetID == 9:
	xStart3 = [0.240,0.570,0.082,0.058,0.172,-1.049]
elif dataSetID == 13:
	xStart3 = [0.325,0.388,0.079,0.053,0.154,-1.414]
elif dataSetID == 19:
	xStart3 = [0.138,0.393,0.068,0.065,0.178,-3.712]
