...
if dataSetID == 1:
	xStart3 = [0.353,0.480,0.054,0.053,0.164]
elif dataSetID == 2:
	xStart3 = [0.314,0.411,0.062,0.071,0.179]
elif dataSetID == 6:
	xStart3 = [0.335,0.303,0.056,0.044,0.115]
elif dataSetID == 9:
	xStart3 = [0.352,0.503,0.092,0.047,0.073]
elif dataSetID == 13:
	xStart3 = [0.257,0.383,0.096,0.072,0.090]
elif dataSetID == 19:
	xStart3 = [0.121,0.420,0.080,0.074,0.189]
